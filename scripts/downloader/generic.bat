...
%youtube_dl% %default_config% %conf% %aria2% %subs% %thumbs% -P home:"%loc%" -o "%%(title)s-%generic_qual%-%%(id)s.%%(ext)s" %custom_config_all% %cookies% "%url%" && set generic_download_status=1 && goto :EOF
set /a try=%try%+1
