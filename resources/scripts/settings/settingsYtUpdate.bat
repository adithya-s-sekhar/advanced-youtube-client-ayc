...
if /i %yt_updated% == 0 call tui windowSize %small_width% 23
if /i %yt_updated% == 0 if /i %yt_no_update% == 1 call tui windowSize %small_width% 25
if /i %yt_updated% == 1 call tui windowSize %small_width% 25
color %theme_colors%
cls
call tui bannerSmall
echo.
if /i %yt_updated% == 0 if /i %yt_no_update% == 0 echo  Current yt-dlp version: %youtube_dl_version%
if /i %yt_updated% == 0 if /i %yt_no_update% == 1 (
...
if /i %ytupd_onstart% == 0 echo        [Disabled]
if /i %ytupd_onstart% == 1 echo        [Enabled]
echo.
call tui borderSmallHalf
echo.
choice /c 0123 /n /m "Select Option (0-3): "
if /i %errorlevel% == 1 goto :EOF
if /i %errorlevel% == 2 call :ytUpdateStable & goto update
if /i %errorlevel% == 3 call :ytUpdateNightly & goto update
if /i %errorlevel% == 4 call settingsToggles YtUpdateOnStart & goto update
...
echo.
%youtube_dl% --update-to stable@2023.11.16 > nul
...
if /i %tmp_youtube_dl_version% == %youtube_dl_version% set yt_no_update=1
goto :EOF
